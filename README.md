...
[![R CMD Check](https://github.com/rivm-syso/DARAutils/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/rivm-syso/DARAutils/actions/workflows/R-CMD-check.yaml)
